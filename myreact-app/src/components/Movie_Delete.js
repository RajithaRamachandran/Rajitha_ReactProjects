...
const Movie_Delete = () => {
    ...
    const disp=()=>{
        axios.get(`"http://localhost:8080/delete"`).then((response)=>{
    ...
    return (
        <div>
            ...
            <Button onClick={disp}fullWidth variant="contained" color="primary">DELETE</Button>
            <Table>
                <TableHead>
                    <TableRow>
